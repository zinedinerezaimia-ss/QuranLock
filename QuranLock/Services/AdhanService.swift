...
final class AdhanService: ObservableObject {
    ...
    @Published var isDownloaded: Bool = true
    ...
    func playAdhan() {
        ...
        do {
            ...
            player?.play()
        } catch { print("❌ Adhan play error: \(error)") }
    }
